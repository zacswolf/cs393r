...
class SLAM {
 ...
 public:
  ...
  void ObservePointCloud(const std::vector<Eigen::Vector2f>& cloud, const std::vector<Eigen::Vector2f>& cloud_open, std::vector<Eigen::Vector2f>& new_points, std::vector<Eigen::Vector2f>& new_points_open);
